...
void forwardQuickTest(int size, function<int(int[], int, int)> partitionMethod) {
    ofstream outFile("./output/ForwardQuickSort2.csv");

    for (int n = 12200; n <= size; n++) {
...
void reverseQuickTest(int size, function<int(int[], int, int)> partitionMethod) {
    ofstream outFile("./output/ReverseQuickSort2.csv");

    for (int n = 14400; n <= size; n++) {
...
int main() {
    ...
    revIns.join();
    */
    forwardQuickTest(1000000, partitionOnePointer);
    //reverseQuickTest(1000000, partitionOnePointer);
    /*
